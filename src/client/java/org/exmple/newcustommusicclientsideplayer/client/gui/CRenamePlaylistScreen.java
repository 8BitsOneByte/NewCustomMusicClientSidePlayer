...
public final class CRenamePlaylistScreen extends Screen {
    ...
    private static final Component TITLE = Component.translatable("screen.custommusicclientsideplayer.rename_playlist.title");
    private static final Component NAME_LABEL = Component.translatable("screen.custommusicclientsideplayer.playlist_name");
    private static final Component SAME_AS_ORIGINAL_ERROR = Component.translatable("screen.custommusicclientsideplayer.error.rename_same_as_original");
